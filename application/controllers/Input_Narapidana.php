	...
	class Input_Narapidana extends CI_Controller
	{
		...
		public function save()
		{
			...
			if ($today < 25 || $today > 28) {
				...
				redirect('input_narapidana'); // ganti sesuai route form kamu
				return;
			}
			...
			if ($faktor) {
				foreach ($faktor as $id_faktor => $value) {
					$row = $this->Input_Narapidana_Model->getFaktorById(
						$id_faktor,
					);
			...
			// Mapping UUID instrument -> aturan nilai
			$mapping = [
				// Instrumen 1
				"e0eba92c-8d48-11f0-808b-54e1ad047dec" => [
					["min" => 71, "max" => 100, "id_antisipasi" => 1], // Tinggi
					["min" => 41, "max" => 70, "id_antisipasi" => 2], // Sedang
					["min" => 0, "max" => 40, "id_antisipasi" => 3], // Rendah
				],

				// Instrumen 2
				"ed689f05-8d48-11f0-808b-54e1ad047dec" => [
					["min" => 71, "max" => 100, "id_antisipasi" => 4], // Tinggi
					["min" => 41, "max" => 70, "id_antisipasi" => 5], // Sedang
					["min" => 0, "max" => 40, "id_antisipasi" => 6], // Rendah
				],
			];

			$id_antisipasi = null;

			// Pastikan mapping untuk UUID ada
